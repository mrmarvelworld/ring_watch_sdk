...
/// 设备圈号
@property (nonatomic, readonly) NSInteger deviceSize;
/// 设备颜色
@property (nonatomic, readonly) NSInteger deviceColor;
/// 设备型号
...
@class JLRecordParams;
@class JLSpeechRecognition;
@class JLOpusDecoder;

SWIFT_CLASS("_TtC12YCProductSDK25JLAudioRecognitionManager") SWIFT_AVAILABILITY(ios,introduced=10.0)
@interface JLAudioRecognitionManager : NSObject <JLOpusDecoderDelegate, JL_SpeexManagerDelegate>
/// 设备触发启动录音
- (void)speexManager:(JL_SpeexManager * _Nonnull)manager StartByDeviceWithParam:(JLRecordParams * _Nonnull)param;
/// 设备触发停止录音
- (void)speexManager:(JL_SpeexManager * _Nonnull)manager StopByDeviceWithParam:(JLSpeechRecognition * _Nonnull)param;
- (void)speexManager:(JL_SpeexManager * _Nonnull)manager Status:(JL_SpeakType)status By:(JLCMDOriginator)originator With:(JLRecordParams * _Nullable)params;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// 接收OPUS音频数据
- (void)speexManager:(JL_SpeexManager * _Nonnull)manager Audio:(NSData * _Nonnull)data;
/// 录音状态变更
- (void)speexManager:(JL_SpeexManager * _Nonnull)manager Status:(JL_SpeakType)status;
- (void)opusDecoder:(JLOpusDecoder * _Nonnull)decoder Data:(NSData * _Nullable)data error:(NSError * _Nullable)error;
@end
...
typedef SWIFT_ENUM(uint8_t, YCAppControlMeasureHealthDataType, open) {
  ...
  YCAppControlMeasureHealthDataTypeBloodFat = 9,
  YCAppControlMeasureHealthDataTypeHrv = 10,
  YCAppControlMeasureHealthDataTypePpg = 11,
  YCAppControlMeasureHealthDataTypePressure = 12,
...
typedef SWIFT_ENUM(uint8_t, YCBusinessCardType, open) {
  ...
  YCBusinessCardTypeLockCode = 0xF3,
  YCBusinessCardTypeUnlockCode = 0xF4,
};

/// 充电状态
typedef SWIFT_ENUM(uint8_t, YCChargeStatus, open) {
  YCChargeStatusDischarging = 0x00,
  YCChargeStatusCharging = 0x01,
};
...
typedef SWIFT_ENUM(uint8_t, YCCollectDataType, open) {
  ...
  YCCollectDataTypeHengAiBloodPressure = 9,
  YCCollectDataTypeHengAiPressure = 10,
  YCCollectDataTypeJiuleIBI = 11,
  YCCollectDataTypeJiuleBloodPressure = 12,
  YCCollectDataTypeJiuleGuardianship = 13,
};
...
typedef SWIFT_ENUM(uint8_t, YCDeleteHealthDataType, open) {
  ...
  YCDeleteHealthDataTypeBackgroundReminderRecord = 0x4D,
  YCDeleteHealthDataTypeBodyIndexData = 0x4E,
  YCDeleteHealthDataTypeHistoryWearData = 0x68,
};
...
/// 查询算法授权基本信息
SWIFT_CLASS("_TtC12YCProductSDK28YCDeviceAlgorithmInformation")
@interface YCDeviceAlgorithmInformation : NSObject
/// 算法厂商
@property (nonatomic, readonly) uint8_t algorithmManufacturers;
/// 设备 ID 类型
@property (nonatomic, readonly) uint8_t deviceIdType;
/// 激活状态
@property (nonatomic, readonly) uint8_t activatState;
/// 设备ID长度
@property (nonatomic, readonly) uint8_t deviceIdLength;
/// 设备ID
...
/// 4G 手表绑定状态
typedef SWIFT_ENUM(uint8_t, YCDeviceBind4GState, open) {
  YCDeviceBind4GStateBinding = 0,
  YCDeviceBind4GStateSuccess = 1,
  YCDeviceBind4GStateFail = 2,
};

typedef SWIFT_ENUM(uint8_t, YCDeviceBindingState, open) {
  YCDeviceBindingStateUnbound = 0x00,
  YCDeviceBindingStateBound = 0x01,
};
...
typedef SWIFT_ENUM(uint8_t, YCDeviceControlType, open) {
  ...
  YCDeviceControlTypeSedentaryReminders = 0x16,
  YCDeviceControlTypeReportWarningEvent = 0x17,
  YCDeviceControlTypeBindResult = 0x19,
};
...
/// ECGModel状态
typedef SWIFT_ENUM(uint8_t, YCDeviceECGModelState, open) {
  YCDeviceECGModelStateNormal = 0,
  YCDeviceECGModelStateCheck = 1,
};
...
/// 健康数据类型
typedef SWIFT_ENUM(uint8_t, YCDeviceHealthDataType, open) {
  YCDeviceHealthDataTypeHeartRate = 0,
  YCDeviceHealthDataTypeBloodOxygen = 1,
};
...
typedef SWIFT_ENUM(uint8_t, YCDeviceLanguageType, open) {
  ...
  YCDeviceLanguageTypeBahasaIndonesia = 0x0E,
...
typedef SWIFT_ENUM(uint8_t, YCDeviceMCUType, open) {
  ...
  YCDeviceMCUTypeAc707n = 5,
  YCDeviceMCUTypeRm12xx = 6,
};
...
/// 电量统计信息
SWIFT_CLASS("_TtC12YCProductSDK23YCDevicePowerStatistics")
@interface YCDevicePowerStatistics : NSObject
/// 上次充电结束时间
@property (nonatomic, readonly) NSInteger lastChargingEndTimestamp;
/// 使用时长
@property (nonatomic, readonly) NSInteger useDuration;
/// 亮屏时长
@property (nonatomic, readonly) NSInteger screenOnDuration;
/// 通话时长
@property (nonatomic, readonly) NSInteger callDuration;
/// 音乐时长
@property (nonatomic, readonly) NSInteger musicDuration;
/// 健康测量时长
@property (nonatomic, readonly) NSInteger healthMeasurementDuration;
/// 消息推送条数
@property (nonatomic, readonly) NSInteger pushMessagesCount;
/// 上次充电结束电量
@property (nonatomic, readonly) NSInteger lastChargingEndPower;
/// 当前电量
@property (nonatomic, readonly) NSInteger currentPower;
/// 字符串表示
@property (nonatomic, readonly, copy) NSString * _Nonnull toString;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// 睡眠状态
typedef SWIFT_ENUM(uint8_t, YCDeviceSleepState, open) {
  YCDeviceSleepStateNotSleep = 0,
  YCDeviceSleepStateSleeping = 1,
};
...
/// 上报的警告事件
typedef SWIFT_ENUM(uint8_t, YCDeviceWarningEvent, open) {
  YCDeviceWarningEventLowBattery = 0,
  YCDeviceWarningEventAlwayHighHeartRate = 1,
  YCDeviceWarningEventAlwayLowHeartRate = 2,
  YCDeviceWarningEventAlwaySportHighHeartRate = 3,
  YCDeviceWarningEventAlwaySportLowHeartRate = 4,
  YCDeviceWarningEventAlwayLowBloodOxygen = 5,
  YCDeviceWarningEventAlwayHighTemperature = 6,
  YCDeviceWarningEventWearReminder = 7,
  YCDeviceWarningEventElectronicFence = 8,
  YCDeviceWarningEventSportTargetFinish = 9,
};
...
typedef SWIFT_ENUM(uint8_t, YCEmbeddedPeripheralFirmwareType, open) {
  ...
  YCEmbeddedPeripheralFirmwareTypeJieliOTA = 3,
};
...
enum YCHealthDataBackgroundReminderType : uint8_t;

/// 后台提醒记录
SWIFT_CLASS("_TtC12YCProductSDK40YCHealthDataBackgroundReminderRecordData")
@interface YCHealthDataBackgroundReminderRecordData : NSObject
/// 开始时间戳
@property (nonatomic, readonly) NSInteger startTimeStamp;
/// 提醒类型
@property (nonatomic, readonly) enum YCHealthDataBackgroundReminderType remindType;
/// 显示
@property (nonatomic, readonly, copy) NSString * _Nonnull toString;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// 提醒类型
typedef SWIFT_ENUM(uint8_t, YCHealthDataBackgroundReminderType, open) {
  YCHealthDataBackgroundReminderTypeHeartRate = 0,
  YCHealthDataBackgroundReminderTypeBloodPressure = 1,
  YCHealthDataBackgroundReminderTypeBloodOxygen = 2,
  YCHealthDataBackgroundReminderTypeRespirationRate = 3,
  YCHealthDataBackgroundReminderTypeBodyTemperature = 4,
  YCHealthDataBackgroundReminderTypeBloodGlucose = 5,
  YCHealthDataBackgroundReminderTypeUricAcid = 6,
  YCHealthDataBackgroundReminderTypeBloodKetone = 7,
  YCHealthDataBackgroundReminderTypeEda = 8,
  YCHealthDataBackgroundReminderTypeBloodFat = 9,
  YCHealthDataBackgroundReminderTypeHrv = 10,
  YCHealthDataBackgroundReminderTypePpg = 11,
  YCHealthDataBackgroundReminderTypeSedentary = 0x61,
  YCHealthDataBackgroundReminderTypeReachGoal = 0x62,
  YCHealthDataBackgroundReminderTypeAntiLost = 0x63,
  YCHealthDataBackgroundReminderTypeBluetoothNotConnected = 0x64,
  YCHealthDataBackgroundReminderTypeFindPhone = 0x65,
  YCHealthDataBackgroundReminderTypeFindDevice = 0x66,
  YCHealthDataBackgroundReminderTypeDrinkWater = 0x67,
  YCHealthDataBackgroundReminderTypeTakeMedicine = 0x68,
  YCHealthDataBackgroundReminderTypeLowBattery = 0xC1,
  YCHealthDataBackgroundReminderTypeCharging = 0xC2,
  YCHealthDataBackgroundReminderTypeFullCharge = 0xC3,
  YCHealthDataBackgroundReminderTypeUnknow = 0xFF,
};
...
typedef SWIFT_ENUM(uint8_t, YCHealthDataBloodPressureMode, open) {
  ...
  YCHealthDataBloodPressureModePpg = 3,
  YCHealthDataBloodPressureModeEcg = 4,
  YCHealthDataBloodPressureModeAccurate_bp = 5,
  YCHealthDataBloodPressureModeUnknown = 6,
};


/// 身体指数
SWIFT_CLASS("_TtC12YCProductSDK25YCHealthDataBodyIndexData")
@interface YCHealthDataBodyIndexData : NSObject
/// 开始时间戳
@property (nonatomic, readonly) NSInteger startTimeStamp;
/// 负荷指数
@property (nonatomic, readonly) double loadIndex;
/// HRV指数
@property (nonatomic, readonly) double hrvIndex;
/// 压力指数
@property (nonatomic, readonly) double pressureIndex;
/// 身体指数
@property (nonatomic, readonly) double bodyIndex;
/// 交感神经指数
@property (nonatomic, readonly) double sympatheticActivityIndex;
/// SDNNHRV
@property (nonatomic, readonly) NSInteger sdnnHRV;
/// 最大报氧量
@property (nonatomic, readonly) NSInteger vo2max;
/// pnn50
@property (nonatomic, readonly) NSInteger pnn50;
/// RMSSD
@property (nonatomic, readonly) NSInteger rmssd;
/// LF
@property (nonatomic, readonly) NSInteger lf;
/// HF
@property (nonatomic, readonly) NSInteger hf;
/// LF/HF 比率
@property (nonatomic, readonly) double lf_hf_rate;
/// 字符串
@property (nonatomic, readonly, copy) NSString * _Nonnull toString;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
typedef SWIFT_ENUM(uint8_t, YCHealthDataInvasiveComprehensiveDataMode, open) {
  YCHealthDataInvasiveComprehensiveDataModeImprecise = 0,
  YCHealthDataInvasiveComprehensiveDataModeAccurate = 1,
};
...
typedef SWIFT_ENUM(uint8_t, YCHealthDataMeasureMode, open) {
  ...
  YCHealthDataMeasureModeInflated = 2,
  YCHealthDataMeasureModePpg = 3,
  YCHealthDataMeasureModeEcg = 4,
  YCHealthDataMeasureModeAccurate_bp = 5,
};
...
typedef SWIFT_ENUM(NSInteger, YCHealthDataSleepType, open) {
  ...
  YCHealthDataSleepTypeFewSleep = 0xF5,
};
...
typedef SWIFT_ENUM(uint8_t, YCLocationInformationType, open) {
  ...
  YCLocationInformationTypeElectronicFence = 2,
};
...
/// ECG状态模式
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger ecgModel;)
+ (NSInteger)ecgModel SWIFT_WARN_UNUSED_RESULT;
+ (void)setEcgModel:(NSInteger)value;
/// 生产连接使用(普通状态无须使用)
...
///
+ (void)startSentimentMeasurement:(CBPeripheral * _Nullable)peripheral completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 关闭情绪测量
/// \param peripheral 连接设备
///
/// \param completion 是否关闭成功
///
+ (void)stopSentimentMeasurement:(CBPeripheral * _Nullable)peripheral completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
@end
...
/// \param completion <#completion description#>
///
+ (void)startRecord SWIFT_AVAILABILITY(ios,introduced=10.0);
+ (void)stopRecord SWIFT_AVAILABILITY(ios,introduced=10.0);
@end
...
/// \param peripheral 当前设备
///
+ (void)clearCachedHealthData:(CBPeripheral * _Nullable)peripheral;
@end
...
/// 3.5.4.58 APP 下发 4G 手表绑定状态
/// \param peripheral 已连接设备
///
/// \param deviceBindState 设备绑定状态
///
/// \param completion 结果
///
+ (void)queryDeviceBind4GState:(CBPeripheral * _Nullable)peripheral deviceBindState:(enum YCDeviceBind4GState)deviceBindState completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 3.5.4.X APP 下发 4G 手表 Token
/// \param peripheral 已连接设备（默认使用当前连接的设备）
///
/// \param token 要下发的hash值Token（会自动处理为UTF-8编码并添加空字符结尾）
///
/// \param completion 结果回调
///
+ (void)send4GWatchToken:(CBPeripheral * _Nullable)peripheral token:(NSString * _Nonnull)token completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 3.5.4.59 APP 下发域名信息
/// \param peripheral 已连接设备
///
...
/// \param completion 结果
///
+ (void)setDeviceDomainInfo:(CBPeripheral * _Nullable)peripheral domainInfo:(NSString * _Nonnull)domainInfo completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 3.5.4.60 心率、血氧预警背景线下发
/// \param peripheral 已连接设备
///
/// \param deviceBindState 设备绑定状态
///
/// \param backgroundData 下发数据
///
/// \param completion 结果
///
+ (void)setHealthWarningBackground:(CBPeripheral * _Nullable)peripheral deviceHealthDataType:(enum YCDeviceHealthDataType)deviceHealthDataType backgroundData:(NSData * _Nonnull)backgroundData completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
@end
...
/// \param peripheral <#peripheral description#>
///
- (void)refreshDeviceFunction:(CBPeripheral * _Nullable)peripheral completion:(void (^ _Nullable)(enum YCProductState, NSError * _Nullable))completion;
@end
...
/// 修复后的dialMgr：懒加载+完整初始化+设置fileHandleType
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) JLDialUnitMgr * _Nullable dialMgr;)
+ (JLDialUnitMgr * _Nullable)dialMgr SWIFT_WARN_UNUSED_RESULT;
/// flash管理器
...
/// 音频管理器
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) JLAudioRecognitionManager * _Nonnull jlAudioManager SWIFT_AVAILABILITY(ios,introduced=10.0);)
+ (JLAudioRecognitionManager * _Nonnull)jlAudioManager SWIFT_WARN_UNUSED_RESULT;
/// 杰理通讯录信息长度
...
+ (void)prepareJLDeviceForFileOperationWithCompletion:(void (^ _Nonnull)(BOOL, NSString * _Nullable))completion;
/// 写入图片到杰理设备（固定701N_RBG格式，不检查设备类型）
/// \param imageData 图片二进制数据
///
/// \param fileName 设备端保存的文件名（如 “BGP_W111”）
///
/// \param progress 进度回调（0~1）
///
/// \param completion 完成回调（是否成功、错误信息）
///
+ (void)writeImageToJLDeviceWithImageData:(NSData * _Nonnull)imageData fileName:(NSString * _Nonnull)fileName progress:(void (^ _Nonnull)(float))progress completion:(void (^ _Nonnull)(BOOL, NSString * _Nullable))completion;
/// 退出大文件传输模式
/// @param completion 退出结果回调
+ (void)exitBigFileTransmissionModeWithCompletion:(void (^ _Nonnull)(BOOL, NSString * _Nullable))completion;
/// 强重置文件传输环境
/// @param completion 重置结果回调
+ (void)resetFileTransmissionEnvironmentWithCompletion:(void (^ _Nonnull)(BOOL, NSString * _Nullable))completion;
...
@class NSSet;
enum YCSettingHealthType : uint8_t;
...
/// \param completion <#completion description#>
///
+ (void)setDeviceHRVAutomaticMeasurement:(CBPeripheral * _Nullable)peripheral isEnable:(BOOL)isEnable startHour:(uint8_t)startHour startMinute:(uint8_t)startMinute endHour:(uint8_t)endHour endMinute:(uint8_t)endMinute completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 运动心率报警设置
/// \param peripheral 外设
///
/// \param isEnable 报警开关
///
/// \param highValue 最高心率报警阈值 100 – 240
///
/// \param lowValue 最低心率报警阈值 30 - 60
///
/// \param highMinute 高心率报警持续时间 1-100 分钟，默认 10
///
/// \param lowMinute 低心率报警持续时间 1-100 分钟，默认 10
///
/// \param completion <#completion description#>
///
+ (void)setDeviceSportHeartRateWaring:(CBPeripheral * _Nullable)peripheral isEnable:(BOOL)isEnable highValue:(uint8_t)highValue lowValue:(uint8_t)lowValue highMinute:(uint8_t)highMinute lowMinute:(uint8_t)lowMinute completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 设置紧急联系人
/// \param peripheral 外设
///
/// \param contactNumber 紧急联系人个数
///
/// \param phone 手机号
///
/// \param completion <#completion description#>
///
+ (void)setEmergencyContact:(CBPeripheral * _Nullable)peripheral contactNumber:(uint8_t)contactNumber phone:(NSString * _Nullable)phone completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 3.5.2.74 设置测量功能展示开关（Command ID = 0x01,Key=0x49）
/// \param peripheral 连接设备
///
/// \param isEnable 是否使能
///
...
/// \param completion <#completion description#>
///
+ (void)setHealthAuxiliary:(CBPeripheral * _Nullable)peripheral isEnable:(BOOL)isEnable healthType:(enum YCSettingHealthType)healthType completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 3.5.2.74 改置蓝牙改备名修改指令（Command ID = 0x01, Key=0x50）
/// 说明：该功能用于部分项目蓝牙名修改限制，先发修改指今，再发设备蓝牙修改指今。该指令的限制操作由固件来处理，AP端不需固件是否支持，都要下发本指令及设备蓝牙修改指令。
/// \param peripheral 连接设备
///
...
/// \param completion 设置结果
///
+ (void)setDeviceBluetooth:(CBPeripheral * _Nullable)peripheral completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 3.5.2.82 清除计数值（Command ID = 0x01, Key=0x58）
/// 说明：清除设备的计数值。
/// \param peripheral 连接设备
///
/// \param antiLostType 防丢类型
...
/// \param completion 设置结果
///
+ (void)clearCountValue:(CBPeripheral * _Nullable)peripheral completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
@end
...
/// 健康数据自动查询完成通知
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull healthDataAutoQueryCompletedNotification;)
+ (NSNotificationName _Nonnull)healthDataAutoQueryCompletedNotification SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull jlAudioRecordStateDidChangeNotification;)
+ (NSNotificationName _Nonnull)jlAudioRecordStateDidChangeNotification SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull jlAudioRecordResultDidCompleteNotification;)
+ (NSNotificationName _Nonnull)jlAudioRecordResultDidCompleteNotification SWIFT_WARN_UNUSED_RESULT;
/// 取消操作
+ (void)cancel;
@end
...
/// 3.5.3.9 获取设备 LOG (耗时指令 需要等待)
+ (void)queryDeviceLog:(CBPeripheral * _Nullable)peripheral isAllLog:(BOOL)isAllLog completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
...
/// \param completion <#completion description#>
///
+ (void)queryDevicePowerStatistics:(CBPeripheral * _Nullable)peripheral completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 查询设备的睡眠状态
/// \param peripheral <#peripheral description#>
///
/// \param completion <#completion description#>
///
+ (void)queryDeviceSleepState:(CBPeripheral * _Nullable)peripheral completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 查询ECG状态
/// \param peripheral <#peripheral description#>
///
/// \param completion <#completion description#>
///
+ (void)queryECGModel:(CBPeripheral * _Nullable)peripheral completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 3.5.3.40 获取算法授权的基本信息（Command ID = 0x02，Key = 0x29）
+ (void)queryAlgorithmInformation:(CBPeripheral * _Nullable)peripheral completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 3.5.3.40 获取计数值（Command ID = 0x02，Key = 0x2E）
+ (void)queryValueCount:(CBPeripheral * _Nullable)peripheral completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
@end
...
enum YCQueryAlgorithmManufacturersType : uint8_t;
...
/// 3.5.4.61 APP 下发第三方算法授权 KEY（Command ID = 0x03，Key =0x40）
/// \param peripheral 连接设备
///
/// \param algorithmManufacturers 算法厂商
///
/// \param algorithKey 算法key
///
/// \param completion <#completion description#>
///
+ (void)sendAlgorithmManufacturersKeyToDevice:(CBPeripheral * _Nullable)peripheral algorithmManufacturers:(enum YCQueryAlgorithmManufacturersType)algorithmManufacturers algorithKey:(NSString * _Nonnull)algorithKey completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// APP通知手表/戒指退出睡眠
/// \param peripheral 连接设备
///
/// \param completion <#completion description#>
///
+ (void)sendDeviceQuiteSleep:(CBPeripheral * _Nullable)peripheral completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
@end
...
/// \param completion 设置结果
///
+ (void)setDeviceColor:(CBPeripheral * _Nullable)peripheral deviceSize:(uint8_t)deviceSize deviceColor:(uint8_t)deviceColor deviceImgIndex:(uint8_t)deviceImgIndex completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 时间设置
/// \param peripheral 外设
///
/// \param year 年 2000+
...
+ (void)setUTCDeviceSyncPhoneTime:(CBPeripheral * _Nullable)peripheral completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
...
///
/// \param highMinute 高心率报警持续时间  30 - 60 1-100 分钟，默认 10
///
/// \param lowMinute 低心率报警持续时间 1-100 分钟，默认 10
///
/// \param completion 设置结果
///
+ (void)setDeviceHeartRateAlarm:(CBPeripheral * _Nullable)peripheral isEnable:(BOOL)isEnable maxHeartRate:(uint8_t)maxHeartRate minHeartRate:(uint8_t)minHeartRate highMinute:(uint8_t)highMinute lowMinute:(uint8_t)lowMinute completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 健康监测
/// \param peripheral 连接设备
///
/// \param isEnable 是否使能
...
///
+ (void)setDeviceDataCollection:(CBPeripheral * _Nullable)peripheral isEnable:(BOOL)isEnable dataType:(enum YCDeviceDataCollectionType)dataType acquisitionTime:(uint16_t)acquisitionTime acquisitionInterval:(uint16_t)acquisitionInterval completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
...
/// \param minimum 最低血氧值
///
/// \param lowMinute 血氧低预警持续时间 1-90 分钟，默认 10 分钟
///
/// \param completion 结果
///
+ (void)setDeviceBloodOxygenAlarm:(CBPeripheral * _Nullable)peripheral isEnable:(BOOL)isEnable minimum:(uint8_t)minimum lowMinute:(uint8_t)lowMinute completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 设置马达需要时长
/// \param peripheral 连接设备
///
/// \param mode 马达震动类型
...
/// 启动HRV测量
@property (nonatomic, readonly) BOOL isSupportStartHRVMeasurement;
/// 启动血糖测量
@property (nonatomic, readonly) BOOL isSupportStartBloodGlucoseMeasurement;
/// 启动压力测量
@property (nonatomic, readonly) BOOL isSupportStartPressureMeasurement;
/// 启动最大摄氧量测量
@property (nonatomic, readonly) BOOL isSupportStartVo2maxMeasurement;
/// 启动血脂测量
@property (nonatomic, readonly) BOOL isSupportStartBloodFatMeasurement;
/// 启动尿酸测量
@property (nonatomic, readonly) BOOL isSupportStartUricAcidMeasurement;
/// 自定义表盘
@property (nonatomic, readonly) BOOL isSupportCustomWatchface;
/// 零星小睡
@property (nonatomic, readonly) BOOL isSupportFewSleep;
/// App控制手表展示测量功能(血脂，尿酸，血糖功能)
@property (nonatomic, readonly) BOOL isSupportAppShowAuxiliary;
/// 定位数据记录功能
@property (nonatomic, readonly) BOOL isSupportLocationRecord;
/// 第三方算法授权
@property (nonatomic, readonly) BOOL isSupportThirdAlgorithms;
/// 久坐记录数据上报
@property (nonatomic, readonly) BOOL isSupportSedentaryRecordDataReporting;
/// 恒爱高科精准光电血压
@property (nonatomic, readonly) BOOL isSupportHengAiPreciseBloodPressure;
/// 恒爱高科精准情绪压力
@property (nonatomic, readonly) BOOL isSupportHengAiPrecisePressure;
/// App控制手表展示测量功能(血氧功能)
@property (nonatomic, readonly) BOOL isSupportAppShowBloodOxygen;
/// App控制手表展示测量功能(非精准血压)
@property (nonatomic, readonly) BOOL isSupportAppShowAuxiliaryBloodPressure;
/// App控制手表展示测量功能(心率功能)
@property (nonatomic, readonly) BOOL isSupportAppShowHeartRate;
/// App控制手表展示测量功能(精准血压功能)
@property (nonatomic, readonly) BOOL isSupportAppShowAccurateBloodPressure;
/// App控制手表展示测量功能(心电功能)
@property (nonatomic, readonly) BOOL isSupportAppShowECG;
/// App控制手表展示测量功能(HRV功能)
@property (nonatomic, readonly) BOOL isSupportAppShowHRV;
/// App控制手表展示测量功能(温度功能)
@property (nonatomic, readonly) BOOL isSupportAppShowTemperature;
/// 是否支持4G绑定功能
@property (nonatomic, readonly) BOOL isSupport4GBind;
/// 非精准血糖
@property (nonatomic, readonly) BOOL isSupportAuxiliaryWithBloodGlucose;
/// 非精准尿酸
@property (nonatomic, readonly) BOOL isSupportAuxiliaryWithUricAcid;
/// 非精准血脂
@property (nonatomic, readonly) BOOL isSupportAuxiliaryWithBloodFat;
/// 心率测量开关
@property (nonatomic, readonly) BOOL isSupportAuxiliaryHeartRateMeasurementSwitch;
/// 血氧测量开关
@property (nonatomic, readonly) BOOL isSupportAuxiliaryBloodOxygenMeasurementSwitch;
/// 体温测量开关
@property (nonatomic, readonly) BOOL isSupportAuxiliaryBodyTemperatureMeasurementSwitch;
/// 非精准血压
@property (nonatomic, readonly) BOOL isSupportAuxiliaryBloodPressureMeasurementSwitch;
/// 精准血压开关
@property (nonatomic, readonly) BOOL isSupportAccurateBloodPressureMeasurementSwitch;
/// 心电测量开关
@property (nonatomic, readonly) BOOL isSupportAuxiliaryECGMeasurementSwitch;
/// HRV测量开关
@property (nonatomic, readonly) BOOL isSupportAuxiliaryHRVMeasurementSwitch;
/// 精准血压测量
...
/// 是否支持设备本地运动上传
@property (nonatomic, readonly) BOOL isSupportLocalSportDataUpload;
/// 是否支持第三方Logo显示
@property (nonatomic, readonly) BOOL isSupportShowBandLogo;
/// 是否支持运动断开延迟
@property (nonatomic, readonly) BOOL isSupportMotionDelayDisconnect;
/// 是否支持电量统计上传
@property (nonatomic, readonly) BOOL isSupportPowerStatisticsUpload;
/// 是否支持压力测量
@property (nonatomic, readonly) BOOL isSupportPressure;
/// 是否支持最大摄氧量
@property (nonatomic, readonly) BOOL isSupportVo2max;
/// 血糖测量外挂
@property (nonatomic, readonly) BOOL isSupportBloodGlucosePlugIn;
/// 血脂测量外挂
@property (nonatomic, readonly) BOOL isSupportBloodFatPlugIn;
/// 尿酸测量外挂
@property (nonatomic, readonly) BOOL isSupportUricAcidPlugIn;
/// 血酮测量外挂
@property (nonatomic, readonly) BOOL isSupportBloodKetonePlugIn;
/// 获取功能列表
@property (nonatomic, readonly, copy) NSString * _Nonnull toString;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
typedef SWIFT_ENUM(NSInteger, YCProductLogLevel, open) {
  ...
  YCProductLogLevelInfo = 2,
  YCProductLogLevelError = 3,
};
...
/// 心率监测模式
@property (nonatomic, readonly) NSInteger heartMonitoringModel;
/// 监测间隔时间
...
/// 算法厂商
typedef SWIFT_ENUM(uint8_t, YCQueryAlgorithmManufacturersType, open) {
  YCQueryAlgorithmManufacturersTypeGongmo = 0,
  YCQueryAlgorithmManufacturersTypeHengai = 1,
};
...
typedef SWIFT_ENUM(uint8_t, YCQueryHealthDataType, open) {
  ...
  YCQueryHealthDataTypeBackgroundReminderRecord = 0x31,
  YCQueryHealthDataTypeBodyIndexData = 0x33,
  YCQueryHealthDataTypeHistoryWearData = 0x66,
};
...
/// 实时身体指数数据
SWIFT_CLASS("_TtC12YCProductSDK23YCReceivedBodyIndexInfo")
@interface YCReceivedBodyIndexInfo : NSObject
/// 负荷指数
@property (nonatomic, readonly) double loadIndex;
/// HRV指数
@property (nonatomic, readonly) double hrvIndex;
...
@property (nonatomic, readonly) NSInteger sdnnHRV;
/// 最大摄氧量
@property (nonatomic, readonly) NSInteger vo2maxIndex;
/// pnn50
@property (nonatomic, readonly) NSInteger pnn50Index;
/// RMSSD
@property (nonatomic, readonly) NSInteger rmssdIndex;
/// LF
@property (nonatomic, readonly) NSInteger lfIndex;
/// HF
@property (nonatomic, readonly) NSInteger hfIndex;
/// LF/HF 比率
@property (nonatomic, readonly) double lf_hf_rate;
/// 字符串
@property (nonatomic, readonly, copy) NSString * _Nonnull toString;
...
/// 充电状态及电量上传数据模型
SWIFT_CLASS("_TtC12YCProductSDK30YCReceivedChargeStatusDataInfo")
@interface YCReceivedChargeStatusDataInfo : NSObject
/// 充电状态（1 byte，对应协议的“充电状态”字段）
@property (nonatomic, readonly) enum YCChargeStatus chargeStatus;
/// 电量（1 byte，0-100，对应协议的“电量”字段）
@property (nonatomic, readonly) uint8_t batteryLevel;
/// 预留字段（8 byte，协议默认填0，这里用数组存储）
...
@property (nonatomic, readonly) double bloodGlucose;
/// 尿酸
@property (nonatomic, readonly) double uricAcid;
/// 血脂
@property (nonatomic, readonly) double bloodFat;
/// 打印字符串
@property (nonatomic, readonly, copy) NSString * _Nonnull toString;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
typedef SWIFT_ENUM(uint8_t, YCReceivedRealTimeDataType, open) {
  ...
  YCReceivedRealTimeDataTypeBodyIndexData = 16,
  YCReceivedRealTimeDataTypeHengAiWaveData = 0x12,
  YCReceivedRealTimeDataTypeWearData = 0x13,
  YCReceivedRealTimeDataTypePowerData = 0x15,
  YCReceivedRealTimeDataTypePpiData = 0x16,
};


/// 实时恒爱数据
SWIFT_CLASS("_TtC12YCProductSDK36YCReceivedRealTimeHengAiWaveDataInfo")
@interface YCReceivedRealTimeHengAiWaveDataInfo : NSObject
/// 心率值
@property (nonatomic, readonly) NSInteger type;
/// 收缩压
@property (nonatomic, readonly, strong) NSData * _Nonnull content;
@property (nonatomic, readonly, copy) NSString * _Nonnull toString;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
enum YCWearingType : uint8_t;

/// 设备佩戴数据
SWIFT_CLASS("_TtC12YCProductSDK31YCReceivedWearingStatusDataInfo")
@interface YCReceivedWearingStatusDataInfo : NSObject
/// 当前时间戳
@property (nonatomic, readonly) NSInteger startTimeStamp;
/// 佩戴状态
@property (nonatomic, readonly) enum YCWearingType wearType;
@property (nonatomic, readonly, copy) NSString * _Nonnull toString;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// 3.5.2.3 目标设置类型
typedef SWIFT_ENUM(uint8_t, YCSettingHealthType, open) {
  YCSettingHealthTypeBloodGlucose = 0,
  YCSettingHealthTypeUricAcid = 1,
  YCSettingHealthTypeBloodFat = 2,
  YCSettingHealthTypeHeartRate = 3,
  YCSettingHealthTypeBloodOxygen = 4,
  YCSettingHealthTypeBodyTemperature = 5,
  YCSettingHealthTypeAuxiliaryBloodPressure = 6,
  YCSettingHealthTypeAccurateBloodPressure = 7,
  YCSettingHealthTypeEcg = 8,
  YCSettingHealthTypeHrv = 9,
};
...
typedef SWIFT_ENUM(uint8_t, YCWaveDataType, open) {
  ...
  YCWaveDataTypeHengAiBPData = 5,
  YCWaveDataTypeHengAiPressure = 6,
  YCWaveDataTypeHengAiMultiBOData = 7,
  YCWaveDataTypePpiData = 8,
};
...
/// 佩戴类型
typedef SWIFT_ENUM(uint8_t, YCWearingType, open) {
  YCWearingTypePlace = 0,
  YCWearingTypeCharge = 1,
  YCWearingTypeWear = 2,
};
